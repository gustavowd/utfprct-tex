...
%% -- Opções da classe UTFPRCT-TEX --
  ...
  fontemodern,%% Fonte do texto: fontetimes (times), fontearial (arial) ou fontecourier (courier), fontemodern (lmodern - default latex). Times and Arial are ABNT recommended
...
%%
%\incluirfichacatalografica{licenca_ppgee.pdf}%%1
